...
import com.ge.predix.solsvc.fdh.router.service.spring.HelloController;
...
public class HelloControllerTest {
	...
	public void getHello() throws Exception {
		this.mvc.perform(MockMvcRequestBuilders.get("/").accept(MediaType.APPLICATION_JSON)) //$NON-NLS-1$
