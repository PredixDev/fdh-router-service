 ...
 * @author predix -
 */
public interface PutFieldDataService
{
     ...
     * @return -
     */
    PutFieldDataResult putFieldData(PutFieldDataRequest singleRequest, Map<Integer, Model> modelLookupMap, List<Header> headers);
