...
public class FdhRestCloudConfig implements EnvironmentAware, IFdhRestConfig
{
    ...
    @Value("${predix_dataexchange_restProtocol:https}")
    private String  restProtocol;
    @Value("${predix_dataexchange_restHost}")
    private String  restHost;
    @Value("${predix_dataexchange_restPort:443}")
    private String  restPort;
    @Value("${predix_dataexchange_restBaseResource:services/fdhrouter/fielddatahandler}")
