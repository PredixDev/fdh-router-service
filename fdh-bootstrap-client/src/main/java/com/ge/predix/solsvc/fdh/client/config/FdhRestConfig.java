...
@Component
@Profile("local")
public class FdhRestConfig implements EnvironmentAware, IFdhRestConfig
{
    @SuppressWarnings("unused")
    private static Logger log = LoggerFactory.getLogger(FdhRestConfig.class);
    
    @Value("${predix.fdh.restProtocol:http}")
    private String  restProtocol;
    @Value("${predix.fdh.restHost:localhost}")
    private String  restHost;
    @Value("${predix.fdh.restPort:9092}")
    private String  restPort;
    @Value("${predix.fdh.restBaseResource:timeseries}")
