...
public class TimeseriesGetFieldDataIT
{
            ...
            throws IllegalStateException, IOException
    {
        ...
        log.debug("================================");
        String timeseriesField = "/asset/assetTag/crank-frame-dischargepressure";
        ...
        GetFieldDataRequest request = TestData.getFieldDataRequestwithTs(timeseriesField, timeseriesFieldSource,
                timeseriesExpectedDataType, "Compressor-2015:DischargePressure", "5d-ago", null);
            ...
            throws IllegalStateException, IOException
    {
        ...
        GetFieldDataRequest request = TestData.getFieldDataRequestwithAssetCriteriaAndTs(timeseriesField, timeseriesFieldSource, timeseriesExpectedDataType,
                timeseriesTagname,  "5d-ago", null, assetUri, assetFilter, assetAttribute, assetSource, assetExpectedDataType, assetResultId);
