...
public class AssetPutFieldDataIT
{

    @SuppressWarnings("unused")
    private static final Logger     log = LoggerFactory.getLogger(AssetPutFieldDataIT.class);
    ...
    public void testPutFieldData()
            throws IOException
    {
        PutFieldDataRequest request = TestData.assetPutFieldDataRequest();
