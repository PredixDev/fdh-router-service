...
public class GetAndPutFieldDataHandlerTest 
{
    ...
    public void testNoModelInAssetForPostOnClassThatDoesNotExist() throws IllegalStateException, IOException
    {
       ...
       /* BasicStatusLine lineGet2 = new BasicStatusLine(protoGet, HttpStatus.SC_OK, "test reason for Get2");
        ...
        PutFieldDataResult response2 = this.putFieldDataProcessor.putData(putFieldDataRequest, modelLookupMap , headers, HttpPost.METHOD_NAME);
    ...
    @Test
    @SuppressWarnings("unused")
    public void getPutRequestWithMetaData() {
        PutFieldDataRequest request = createPutRequestNoFilterForMetaData();
        String json = this.jsonMapper.toJson(request);
    }
