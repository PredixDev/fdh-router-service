...
import static com.ge.fdh.asset.common.DateUtil.ISO_8601_FORMAT;
import static com.ge.fdh.asset.common.DateUtil.getDateFromISOString;
import static com.ge.fdh.asset.common.DateUtil.getDateFromString;
import static com.ge.fdh.asset.common.DateUtil.getISOStringFromDate;
...
import com.ge.fdh.asset.common.AssetQuery;
import com.ge.fdh.asset.common.ClassificationQuery;
import com.ge.fdh.asset.common.Operator;
import com.ge.fdh.asset.common.Reading;
import com.ge.fdh.asset.common.RequestContext;
import com.ge.fdh.asset.utils.AmsHttpClientErrorException;
import com.ge.fdh.asset.utils.AmsHttpServerErrorException;
...
public class CommonObjectsTest extends ServiceTestBase
{
    ...
    public void classificationQuery()
    {
        String uri = "/cl123";
        // case 1 - with uri
        ClassificationQuery q = new ClassificationQuery(uri);
        Assert.assertTrue(q.getQuery().equals("/cl123"));
        // case 2 - with name
        q = new ClassificationQuery();
        q.addNameFilter("EWO100");
        Assert.assertTrue(q.getQuery().equals("?filter=name=EWO100"));
     ...
     */
    @Test
    public void assetQuery()
    {
        String uri = "/a123";
        AssetQuery q = new AssetQuery(uri);
        Assert.assertTrue(q.getQuery().equals("/a123"));
        q.addUriFilter(uri);
        q.getQuery();
        Assert.assertTrue(q.getQuery().equals("/a123"));

        q = new AssetQuery();
        q.addClassificationFilter("/classification/cl135");
        q.getQuery();
        Assert.assertTrue(q.getQuery().equals("?filter=specification=/classification/cl135"));

        q = new AssetQuery();
        q.addAssetIdFilter("asset123");
        q.getQuery();
        Assert.assertTrue(q.getQuery().equals("?filter=assetId=asset123"));

        q = new AssetQuery(uri);
        q.addUriFilter(null);
        q.getQuery();
        Assert.assertTrue(q.getQuery().equals("/a123"));
        Assert.assertTrue(q.hashCode() != 0);
