...
public class PutFieldDataHandlerTest 
{
    ...
    public void testPutFieldDataProcessorOfSomethingThatExtendsModel()
    {
        ...
        PutFieldDataResult result = this.putFieldDataProcessor.putData(putFieldDataRequest, modelLookupMap , headers, HttpPost.METHOD_NAME);
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void testPutRequestWithMetaModel()
    {
        ...
        PutFieldDataRequest putFieldDataRequest = createPutRequestNoFilterForMetaData();
    ...
    private PutFieldDataRequest createPutRequestNoFilterForMetaData()
    {
        PutFieldDataRequest putFieldDataRequest = new PutFieldDataRequest();
        putFieldDataRequest.setCorrelationId("meta-data");
        ...
        metaData.setUri("meta-data-test/"+metaData.getId());
