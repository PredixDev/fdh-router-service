...
public class DMVectorConverter extends BaseConverter
{
            ...
            throws OsacbmConversionException
    {
        ...
        {
            throw new OsacbmConversionException("Incorrect date format specified for time type " //$NON-NLS-1$
                    + osaTime.getTimeType() + " expected format yyyy-MM-dd'T'HH:mm:ss.SSSSSSSSS but actual format" //$NON-NLS-1$
                    + "is " + osaTime.getTime()); //$NON-NLS-1$
        }
