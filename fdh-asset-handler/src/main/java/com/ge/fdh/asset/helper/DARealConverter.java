...
public class DARealConverter extends RealConverter
{
            ...
            throws OsacbmConversionException
    {
        ...
        {
            throw new OsacbmConversionException("Incorrect date format specified for time type "
                    + osaTime.getTimeType() + " expected format yyyy-MM-dd'T'HH:mm:ss.SSSSSSSSS but actual format"
                    + "is " + osaTime.getTime());
        }
