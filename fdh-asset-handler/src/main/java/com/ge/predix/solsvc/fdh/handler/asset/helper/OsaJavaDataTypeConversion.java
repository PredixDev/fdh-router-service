...
public class OsaJavaDataTypeConversion
{
     ...
     */
    public static Object convertOsaDataToJavaStructure(OsaData osaData, SupportedJavaTypes toType)
            throws OsacbmConversionException
    {
        return convertDataEventToJavaStructure(osaData.getDataEvent(), toType);
    }
    /**
