...
sed -i 's/predix-asset.run.aws-usw02-pr.ice.predix.io/predix-asset.run.aws-usw02-pr.ice.predix.io/g' config/com.ge.predix.solsvc.dataexchange.config.config
