...
public class Heartbeat
{
    ...
    public static Response heartbeat(String id)
    {
        ...
        {
            if ( id == null )
                return handleResult("Usage: To reflect back your string, pass a queryParam with id=  e.g. http://localhost:9090/service/fdhtimeseries/fielddatahandler/heartbeat?id=hello world");
